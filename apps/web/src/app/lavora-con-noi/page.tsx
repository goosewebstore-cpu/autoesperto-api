    ...
    <main className="min-h-screen bg-slate-50 px-5 py-12">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 overflow-hidden rounded-3xl bg-slate-950 px-6 py-12 text-white sm:px-12 sm:py-16">
          ...
          <a href={`mailto:goosewebstore@gmail.com?subject=${subject}&body=${body}`} className="mt-8 inline-flex min-h-12 items-center gap-2 rounded-xl bg-blue-600 px-5 text-sm font-extrabold text-white hover:bg-blue-500">Richiedi una proposta <ArrowRight className="h-4 w-4" /></a>
        </section>
        ...
        <section className="mt-10 text-center"><h2 className="text-2xl font-extrabold text-slate-950">Raccontaci cosa vuoi ottenere</h2><p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-600">Indica attività, area geografica, pubblico, obiettivo e budget indicativo. Prepariamo una proposta semplice e misurabile.</p><a href={`mailto:goosewebstore@gmail.com?subject=${subject}&body=${body}`} className="mt-5 inline-flex items-center gap-2 font-extrabold text-blue-700 hover:underline">Scrivi a goosewebstore@gmail.com <ArrowRight className="h-4 w-4" /></a></section>
      </div>
    </main>
  );
}
