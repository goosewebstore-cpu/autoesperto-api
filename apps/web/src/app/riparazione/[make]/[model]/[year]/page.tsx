...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `/riparazione/${resolved.make}/${resolved.model}/${resolved.year}`,
      languages: { 'it-IT': `${siteUrl()}/riparazione/${resolved.make}/${resolved.model}/${resolved.year}` },
    },
    openGraph: {
      type: 'website',
      locale: 'it_IT',
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-5 pt-8 pb-20">
        ...
        <section className="mt-8 rounded-2xl bg-accent p-6 text-white">
          <h2 className="text-lg font-bold">Riparare o rottamare? Dipende dal valore dell&apos;auto</h2>
