      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
            ...
            Valutazione Danni da Foto &amp; Preventivo Ricambi con IA
          </h2>
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            Carica una foto della carrozzeria o del componente danneggiato: l&apos;IA individua il tipo di danno, stima i costi (fai-da-te o officina) e ti mostra i link diretti per i ricambi su eBay, Autodoc e Oscaro.
          </p>
        </div>
      </div>
