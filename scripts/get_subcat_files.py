...
def get_cat_files(cat, limit=10):
...
get_cat_files("Category:Automobile cockpits", 10)
get_cat_files("Category:In-car entertainment", 10)
get_cat_files("Category:Quality images of automobile parts", 10)
get_cat_files("Category:Quality images of automobile interiors", 10)
get_cat_files("Category:Vehicle registration plates of Germany", 10)
