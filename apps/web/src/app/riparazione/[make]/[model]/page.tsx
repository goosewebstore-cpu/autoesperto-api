...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `Costi di riparazione ${make.name} ${model}: stima per anno | AutoEsperto`;
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-5 pt-8 pb-20">
        ...
        <section className="mt-8 rounded-2xl bg-accent p-6 text-white">
          <h2 className="text-lg font-bold">Valuta prima di riparare</h2>
          <p className="text-sm text-white/85 leading-relaxed mt-2">
            ...
            reale di mercato della {make.name} {model} prima di spendere in officina.
          </p>
          <Link
