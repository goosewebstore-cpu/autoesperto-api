...
export default function GuideTableOfContents({ items }: Props) {
  ...
  return (
    <nav
      ...
      className="my-7 rounded-2xl sm:rounded-3xl border border-slate-200/90 bg-white p-4 sm:p-6 shadow-sm"
    >
      <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="text-xs sm:text-sm font-black uppercase tracking-wide text-slate-900 block">
              Indice della Guida
            </span>
        ...
        <button
          ...
          className="px-2.5 py-1 rounded-lg bg-slate-50 border border-slate-200 text-slate-600 text-xs font-bold flex items-center gap-1 sm:hidden transition-colors"
        >
              ...
              <li key={item.id} className="flex items-center gap-3">
                ...
                <a
                  ...
                  className={`text-xs sm:text-sm leading-snug py-1 transition-all cursor-pointer ${
                    isActive
                      ? 'font-bold text-blue-600 translate-x-0.5 underline underline-offset-4'
