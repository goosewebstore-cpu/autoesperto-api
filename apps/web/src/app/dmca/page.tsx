      ...
      sections={[
        {
          ...
          paragraphs: [
            "Se ritieni che un contenuto presente su AutoEsperto violi il tuo diritto d'autore, puoi inviare una segnalazione scritta a legal@autoesperto.it contenente le informazioni elencate di seguito.",
        ...
        },
        {
          ...
          paragraphs: [
            "Le notifiche DMCA devono essere inviate al seguente contatto: legal@autoesperto.it. L'agente designato esaminerà la segnalazione e, se conforme ai requisiti, provvederà alla rimozione o alla disabilitazione dell'accesso al contenuto contestato in tempi ragionevoli.",
          ],
        },
        {
          heading: '3. Contro-notifica (Counter-Notice)',
          paragraphs: [
            "Se ritieni che il tuo contenuto sia stato rimosso per errore o errata identificazione, puoi inviare una contro-notifica a legal@autoesperto.it contenente: (a) la tua firma fisica o elettronica; (b) identificazione del contenuto rimosso e la posizione in cui appariva prima della rimozione; (c) una dichiarazione, sotto pena di falsa testimonianza, che ritieni in buona fede che il contenuto sia stato rimosso per errore; (d) il tuo nome, indirizzo e numero di telefono e il consenso alla giurisdizione del tribunale competente.",
        ...
        },
        {
          heading: '7. Contatti',
          paragraphs: [
            'Per qualsiasi domanda relativa a questa policy o per inviare una segnalazione, scrivi a legal@autoesperto.it.',
          ],
        },
      ]}
    />
